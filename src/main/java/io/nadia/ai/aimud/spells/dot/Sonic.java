...
/**
 * Implementation of the sonic spell.
 */
@MagicSpell(name = "sonic")
public class Sonic extends Spell {

    /**
     * Constructs the sonic dependencies.
     *
     ...
     */
    public Sonic(SkillService skillService, MobileService mobileService, CharacterService characterService, CommunicationService communicationService, EffectService effectService) {
