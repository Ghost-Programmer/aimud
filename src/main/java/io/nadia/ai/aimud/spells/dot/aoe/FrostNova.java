...
/**
 * Implementation of the frostnova spell.
 */
@MagicSpell(name = "frostnova")
public class FrostNova extends Spell {

    /**
     * Constructs the frostnova dependencies.
     *
     ...
     */
    public FrostNova(SkillService skillService, MobileService mopbileService, CharacterService characterService, CommunicationService communicationService, EffectService effectService) {
    ...
    public String getDescription() {
        return "An AoE level 14 spell that unleashes Frost Nova on targets.. Damage and duration scale with skill rank. Usage: cast 'frostnova' <target>";
    }
    ...
    public boolean cast(Mobile mobile, Spell spell, Mobile primaryTarget) {
        ...
        if (effect != null) {
            if (mobile.getUserId() != null) {
                this.communicationService.sendTextMessage(mobile, "\n\nYou unleash a massive blast of Frost Nova starting at " + primaryTarget.getName() + "!");
            }
            this.communicationService.roomMessage(mobile, "\n\n" + mobile.getName() + " unleashes a massive blast of Frost Nova at " + primaryTarget.getName() + "!");
