...
/**
 * Implementation of the firestorm spell.
 */
@MagicSpell(name = "firestorm")
public class Firestorm extends Spell {

    /**
     * Constructs the firestorm dependencies.
     *
     ...
     */
    public Firestorm(SkillService skillService, MobileService mobileService, CommunicationService communicationService, EffectService effectService) {
    ...
    public String getDescription() {
        return "An AoE level 55 spell that unleashes Firestorm on targets.. Damage and duration scale with skill rank. Usage: cast 'firestorm' <target>";
    }
    ...
    public boolean cast(Mobile mobile, Spell spell, Mobile primaryTarget) {
        ...
        if (effect != null) {
            if (mobile.getUserId() != null) {
                this.communicationService.sendTextMessage(mobile, "\n\nYou unleash a massive blast of Firestorm starting at " + primaryTarget.getName() + "!");
            }
            this.communicationService.roomMessage(mobile, "\n\n" + mobile.getName() + " unleashes a massive blast of Firestorm at " + primaryTarget.getName() + "!");
