...
/**
 * Implementation of the dissonantwhisper spell.
 */
@MagicSpell(name = "dissonantwhisper")
public class DissonantWhisper extends Spell {

    /**
     * Constructs the dissonantwhisper dependencies.
     *
     ...
     */
    public DissonantWhisper(SkillService skillService, MobileService mopbileService, CharacterService characterService, CommunicationService communicationService, EffectService effectService) {
    ...
    public String getDescription() {
        return "An AoE level 14 spell that unleashes Dissonant Whisper on targets.. Damage and duration scale with skill rank. Usage: cast 'dissonantwhisper' <target>";
    }
    ...
    public boolean cast(Mobile mobile, Spell spell, Mobile primaryTarget) {
        ...
        if (effect != null) {
            if (mobile.getUserId() != null) {
                this.communicationService.sendTextMessage(mobile, "\n\nYou unleash a massive blast of Dissonant Whisper starting at " + primaryTarget.getName() + "!");
            }
            this.communicationService.roomMessage(mobile, "\n\n" + mobile.getName() + " unleashes a massive blast of Dissonant Whisper at " + primaryTarget.getName() + "!");
            ...
            for (Mobile tgt : targets) {
                ...
                if (tgt.getUserId() != null) {
                    this.communicationService.sendTextMessage(tgt, "\n\n" + mobile.getName() + " engulfs you in Dissonant Whisper!");
                }
            }
            return applied;
        } else {
