...
/**
 * Implementation of the critical electrical spell.
 */
@MagicSpell(name = "critical electrical")
public class CriticalElectrical extends Spell {

    /**
     * Constructs the critical electrical dependencies.
     *
     ...
     */
    public CriticalElectrical(SkillService skillService, MobileService mobileService, CharacterService characterService, CommunicationService communicationService, EffectService effectService) {
