...
/**
 * Implementation of the flamebreath spell.
 */
@MagicSpell(name = "flamebreath")
public class FlameBreath extends Spell {

    /**
     * Constructs the flamebreath dependencies.
     *
     ...
     */
    public FlameBreath(SkillService skillService, MobileService mopbileService, CharacterService characterService, CommunicationService communicationService, EffectService effectService) {
    ...
    public String getDescription() {
        return "An AoE level 30 spell that unleashes Flame Breath on targets.. Damage and duration scale with skill rank. Usage: cast 'flamebreath' <target>";
    }
    ...
    public boolean cast(Mobile mobile, Spell spell, Mobile primaryTarget) {
        ...
        if (effect != null) {
            if (mobile.getUserId() != null) {
                this.communicationService.sendTextMessage(mobile, "\n\nYou unleash a massive blast of Flame Breath starting at " + primaryTarget.getName() + "!");
            }
            this.communicationService.roomMessage(mobile, "\n\n" + mobile.getName() + " unleashes a massive blast of Flame Breath at " + primaryTarget.getName() + "!");
