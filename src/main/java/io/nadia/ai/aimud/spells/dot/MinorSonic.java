...
/**
 * Implementation of the minor sonic spell.
 */
@MagicSpell(name = "minor sonic")
public class MinorSonic extends Spell {

    /**
     * Constructs the minor sonic dependencies.
     *
     ...
     */
    public MinorSonic(SkillService skillService, MobileService mobileService, CharacterService characterService, CommunicationService communicationService, EffectService effectService) {
