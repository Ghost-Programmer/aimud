...
/**
 * Implementation of the bansheewail spell.
 */
@MagicSpell(name = "bansheewail")
public class BansheeWail extends Spell {

    /**
     * Constructs the bansheewail dependencies.
     *
     ...
     */
    public BansheeWail(SkillService skillService, MobileService mopbileService, CharacterService characterService, CommunicationService communicationService, EffectService effectService) {
    ...
    public String getDescription() {
        return "An AoE level 90 spell that unleashes Banshee Wail on targets.. Damage and duration scale with skill rank. Usage: cast 'bansheewail' <target>";
    }
    ...
    public boolean cast(Mobile mobile, Spell spell, Mobile primaryTarget) {
        ...
        if (effect != null) {
            if (mobile.getUserId() != null) {
                this.communicationService.sendTextMessage(mobile, "\n\nYou unleash a massive blast of Banshee Wail starting at " + primaryTarget.getName() + "!");
            }
            this.communicationService.roomMessage(mobile, "\n\n" + mobile.getName() + " unleashes a massive blast of Banshee Wail at " + primaryTarget.getName() + "!");
