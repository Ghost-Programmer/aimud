...
/**
 * Implementation of the absolutezero spell.
 */
@MagicSpell(name = "absolutezero")
public class AbsoluteZero extends Spell {

    /**
     * Constructs the absolutezero dependencies.
     *
     ...
     */
    public AbsoluteZero(SkillService skillService, MobileService mobileService, CharacterService characterService, CommunicationService communicationService, EffectService effectService) {
