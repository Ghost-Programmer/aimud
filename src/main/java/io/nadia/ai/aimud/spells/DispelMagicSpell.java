...
public class DispelMagicSpell extends Spell {
     ...
     */
    protected DispelMagicSpell(SkillService skillService, MobileService mobileService, CommunicationService communicationService, EffectService effectService) {
