...
/**
 * Implementation of the staticfield spell.
 */
@MagicSpell(name = "staticfield")
public class StaticField extends Spell {

    /**
     * Constructs the staticfield dependencies.
     *
     ...
     */
    public StaticField(SkillService skillService, MobileService mobileService, CharacterService characterService, CommunicationService communicationService, EffectService effectService) {
