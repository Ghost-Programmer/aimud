...
/**
 * Implementation of the inferno spell.
 */
@MagicSpell(name = "inferno")
public class Inferno extends Spell {

    /**
     * Constructs the inferno dependencies.
     *
     ...
     */
    public Inferno(SkillService skillService, MobileService mopbileService, CharacterService characterService, CommunicationService communicationService, EffectService effectService) {
    ...
    public String getDescription() {
        return "An AoE level 90 spell that unleashes Inferno on targets.. Damage and duration scale with skill rank. Usage: cast 'inferno' <target>";
    }
    ...
    public boolean cast(Mobile mobile, Spell spell, Mobile primaryTarget) {
        ...
        if (effect != null) {
            if (mobile.getUserId() != null) {
                this.communicationService.sendTextMessage(mobile, "\n\nYou unleash a massive blast of Inferno starting at " + primaryTarget.getName() + "!");
            }
            this.communicationService.roomMessage(mobile, "\n\n" + mobile.getName() + " unleashes a massive blast of Inferno at " + primaryTarget.getName() + "!");
