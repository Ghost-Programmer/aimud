...
/**
 * Implementation of the major sonic spell.
 */
@MagicSpell(name = "major sonic")
public class MajorSonic extends Spell {

    /**
     * Constructs the major sonic dependencies.
     *
     ...
     */
    public MajorSonic(SkillService skillService, MobileService mobileService, CharacterService characterService, CommunicationService communicationService, EffectService effectService) {
