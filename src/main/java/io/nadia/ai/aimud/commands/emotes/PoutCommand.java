...
/**
 * Implementation of the pout social interaction.
 */
@MudCommand(name = "pout", isEmote = true)
public class PoutCommand extends BaseEmoteCommand {
    /**
     * Constructs the pout emote command handler relying on common autowired domain services.
     *
     ...
     */
    @Autowired
    public PoutCommand(CommunicationService communicationService, MobileService mobileService) {
