...
/**
 * Implementation of the giggle social interaction.
 */
@MudCommand(name = "giggle", isEmote = true)
public class GiggleCommand extends BaseEmoteCommand {
    /**
     * Constructs the giggle emote command handler relying on common autowired domain services.
     *
     ...
     */
    @Autowired
    public GiggleCommand(CommunicationService communicationService, MobileService mobileService) {
