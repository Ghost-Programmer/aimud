...
/**
 * Implementation of the grin social interaction.
 */
@MudCommand(name = "grin", isEmote = true)
public class GrinCommand extends BaseEmoteCommand {
    /**
     * Constructs the grin emote command handler relying on common autowired domain services.
     *
     ...
     */
    @Autowired
    public GrinCommand(CommunicationService communicationService, MobileService mobileService) {
