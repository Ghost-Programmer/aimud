...
/**
 * Implementation of the dexterity bard song.
 */
...
public class DexteritySong extends Song {
     ...
     */
    protected DexteritySong(SkillService skillService, MobileService mobileService, CharacterService characterService, CommunicationService communicationService, EffectService effectService) {
