...
/**
 * Implementation of the macabreoverture bard song.
 */
@Component
...
public class MacabreOverture extends Song {
    ...
    /**
     * Constructs the macabreoverture dependencies.
     *
     ...
     */
    public MacabreOverture(SkillService skillService, MobileService mobileService, CommunicationService communicationService, EffectService effectService) {
