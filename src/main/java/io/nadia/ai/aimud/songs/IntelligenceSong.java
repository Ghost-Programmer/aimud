...
public class IntelligenceSong extends Song {
     ...
     */
    protected IntelligenceSong(SkillService skillService, MobileService mobileService, CharacterService characterService, CommunicationService communicationService, EffectService effectService) {
