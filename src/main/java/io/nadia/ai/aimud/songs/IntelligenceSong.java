...
public class IntelligenceSong extends Song {
     ...
     */
    protected IntelligenceSong(SkillService skillService, MobileService mobileService, CommunicationService communicationService, EffectService effectService) {
