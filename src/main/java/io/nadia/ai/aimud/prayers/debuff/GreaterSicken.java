...
public class GreaterSicken extends Prayer {
    ...
    /**
     * Constructs the pray 'greater sicken' dependencies.
     *
     ...
     */
    public GreaterSicken(SkillService skillService, MobileService mobileService, CommunicationService communicationService, EffectService effectService) {
