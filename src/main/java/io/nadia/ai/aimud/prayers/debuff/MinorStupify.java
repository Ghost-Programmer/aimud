...
public class MinorStupify extends Prayer {
    ...
    /**
     * Constructs the pray 'minor stupify' dependencies.
     *
     ...
     */
    public MinorStupify(SkillService skillService, MobileService mobileService, CommunicationService communicationService, EffectService effectService) {
