...
public class MinorLowerResistance extends Prayer {
     ...
     */
    public MinorLowerResistance(SkillService skillService, MobileService mobileService, CommunicationService communicationService, EffectService effectService) {
