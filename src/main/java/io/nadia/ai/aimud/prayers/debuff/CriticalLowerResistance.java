...
public class CriticalLowerResistance extends Prayer {
    ...
    /**
     * Constructs the pray 'critical lowerresistance' dependencies.
     *
     ...
     */
    public CriticalLowerResistance(SkillService skillService, MobileService mobileService, CommunicationService communicationService, EffectService effectService) {
