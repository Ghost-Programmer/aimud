...
/**
 * Implementation of the strength prayer.
 */
...
public class Strength extends Prayer {
     ...
     */
    protected Strength(SkillService skillService, MobileService mobileService, CharacterService characterService, CommunicationService communicationService, EffectService effectService) {
