...
public class DispelMagicPrayer extends Prayer {
     ...
     */
    protected DispelMagicPrayer(SkillService skillService, MobileService mobileService, CommunicationService communicationService, EffectService effectService) {
