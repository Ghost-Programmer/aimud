...
public class CriticalHealing extends Prayer {
     ...
     */
    protected CriticalHealing(SkillService skillService, MobileService mobileService,
    ...
    public boolean pray(Mobile mobile, Prayer prayer, Mobile target) {
        ...
        int healAmount = getDamage(mobile) * 100; 
        ...
        if (mobile.getUserId() != null) {
            communicationService.sendTextMessage(mobile, 
                String.format("\n\nYou lay your hands on %s and heal %d points of damage, mending critical wounds.", 
        ...
        if (target.getUserId() != null && mobile != target) {
            communicationService.sendTextMessage(target,
                String.format("\n\n%s lays their hands on you, rapidly mending your critical wounds for %d points of healing.", 
