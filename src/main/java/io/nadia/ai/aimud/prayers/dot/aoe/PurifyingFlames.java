...
/**
 * Implementation of the purifyingflames prayer.
 */
@Component
...
public class PurifyingFlames extends Prayer {
    ...
    /**
     * Constructs the purifyingflames dependencies.
     *
     ...
     */
    public PurifyingFlames(SkillService skillService, MobileService mobileService, CommunicationService communicationService, EffectService effectService) {
