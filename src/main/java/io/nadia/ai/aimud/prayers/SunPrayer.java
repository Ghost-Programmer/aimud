...
/**
 * SunPrayer standard implementation layer.
 * Pray for the sky to clear and the sun to shine brightly.
 */
...
public class SunPrayer extends Prayer {
    ...
    public SunPrayer(SkillService skillService, MobileService mobileService, CommunicationService communicationService, EffectService effectService, TickService tickService) {
