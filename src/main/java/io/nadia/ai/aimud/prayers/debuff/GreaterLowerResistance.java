...
public class GreaterLowerResistance extends Prayer {
     ...
     */
    public GreaterLowerResistance(SkillService skillService, MobileService mobileService, CommunicationService communicationService, EffectService effectService) {
