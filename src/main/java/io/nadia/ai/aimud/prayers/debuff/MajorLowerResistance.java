...
public class MajorLowerResistance extends Prayer {
     ...
     */
    public MajorLowerResistance(SkillService skillService, MobileService mobileService, CommunicationService communicationService, EffectService effectService) {
