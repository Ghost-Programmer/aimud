...
/**
 * Implementation of the divinehalo prayer.
 */
@Component
@DivinePrayer(name = "divinehalo")
public class DivineHalo extends Prayer {

    /**
     * Constructs the divinehalo dependencies.
     *
     ...
     */
    public DivineHalo(SkillService skillService, MobileService mobileService, CharacterService characterService, CommunicationService communicationService, EffectService effectService) {
     ...
     */
    @Override
    public String getPrayerName() { return "Divine Halo"; }

    /**
     * {@inheritDoc}
     */
    @Override
    public Long getPrayerId() { return 2515L; }

    /**
     * {@inheritDoc}
     */
    @Override
    public Integer getPrayerLevel() { return 90; }
    ...
    public String getDescription() {
        return "A level 90 AoE Damage-Over-Time holy prayer. Usage: pray 'divinehalo' <target>";
    }
    ...
    public boolean pray(Mobile mobile, Prayer prayer, Mobile primaryTarget) {
        ...
        if (effect != null) {
            if (mobile.getUserId() != null) this.communicationService.sendTextMessage(mobile, "\n\nYou engulf the area around " + primaryTarget.getName() + " with Divine Halo!");
            this.communicationService.roomMessage(mobile, "\n\n" + mobile.getName() + " casts a crushing Divine Halo centered on " + primaryTarget.getName() + "!");
