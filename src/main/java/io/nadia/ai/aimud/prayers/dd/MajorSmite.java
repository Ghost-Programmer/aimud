...
/**
 * Implementation of the majorsmite prayer.
 */
@Component
...
public class MajorSmite extends Prayer {
    ...
    /**
     * Constructs the majorsmite dependencies.
     *
     ...
     */
    public MajorSmite(SkillService skillService, MobileService mobileService, CommunicationService communicationService, EffectService effectService) {
