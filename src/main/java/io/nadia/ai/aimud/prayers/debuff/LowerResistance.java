...
public class LowerResistance extends Prayer {
    ...
    /**
     * Constructs the pray 'lowerresistance' dependencies.
     *
     ...
     */
    public LowerResistance(SkillService skillService, MobileService mobileService, CommunicationService communicationService, EffectService effectService) {
