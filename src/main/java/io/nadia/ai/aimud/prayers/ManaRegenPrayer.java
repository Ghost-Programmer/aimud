...
/**
 * Implementation of the manaregen prayer.
 */
...
public class ManaRegenPrayer extends Prayer {
     ...
     */
    protected ManaRegenPrayer(SkillService skillService, MobileService mobileService, CharacterService characterService, CommunicationService communicationService, EffectService effectService) {
