...
--changeset jeff:time-system
ALTER TABLE server_settings
ADD COLUMN mud_hour INTEGER NOT NULL DEFAULT 0,
ADD COLUMN mud_day INTEGER NOT NULL DEFAULT 1,
ADD COLUMN mud_month INTEGER NOT NULL DEFAULT 1,
ADD COLUMN mud_year INTEGER NOT NULL DEFAULT 1;

--changeset jeff:room-light-system
ALTER TABLE rooms
