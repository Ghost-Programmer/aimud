...
VALUES ('db_status', 'R2DBC Connection Established!')
...
INSERT INTO character_classes (id, name, description, strength_mod, intelligence_mod, wisdom_mod, charisma_mod,
                               dexterity_mod, constitution_mod)
VALUES (1, 'Cleric', 'A priestly champion who wields divine magic in service of a higher power.', 0, 0, 2, 0, 0, 0),
       (2, 'Druid', 'A priest of the Old Faith, wielding the powers of nature and adopting animal forms.', 0, 0, 2, 0,
        0, 0),
...
--changeset jeff:6
INSERT INTO races (name, description, strength_mod, intelligence_mod, wisdom_mod, charisma_mod, dexterity_mod,
                   constitution_mod)
VALUES ('Elf', 'A magical people of otherworldly grace, living in the world but not entirely part of it.', 0, 1, 0, 0,
        2, 0),
       ('Halfling',
       ...
       ('Gnome',
        ...
        0, 2, 0, 0, 0, 0),
       ('Dwarf', 'Bold and hardy, dwarves are known as skilled warriors, miners, and workers of stone and metal.', 0, 0,
        0, 0, 0, 2),
       ('Orc', 'Orcs are savage raiders and pillagers with stooped postures, low foreheads, and piggish faces.', 2, 0,
        0, 0, 0, 1);
...
--changeset jeff:9
INSERT INTO rooms (id, name, description, room_type)
VALUES (1, 'Mud Entrance',
...
ALTER TABLE characters
    ADD COLUMN current_mana INTEGER DEFAULT 0;
...
INSERT INTO rooms (id, name, description, room_type, north_id, south_id, east_id, west_id)
VALUES (2, 'The Great Hall', 'A vast, echoing hall with marble floors and high vaulted ceilings.', 'INDOORS', 3, 4, 5,
        1),
       (3, 'Library of Ancient Wisdom', 'Rows of dusty bookshelves line the walls of this quiet chamber.', 'INDOORS',
        NULL, 2, NULL, NULL),
       (4, 'The Alchemist''s Workshop', 'The air is thick with the smell of strange chemicals and bubbling potions.',
        'INDOORS', 2, NULL, NULL, NULL),
...
INSERT INTO effects (id, name, effect_type, modifier1, modifier2, modifier3, modifier4)
VALUES (1, 'Strength +1', 'STRENGTH', 1, 0, 0, 0),
...
--changeset jeff:48
ALTER TABLE character_classes
    ADD COLUMN starting_items TEXT;
UPDATE character_classes
SET starting_items = ''
WHERE starting_items IS NULL;

--changeset jeff:49
ALTER TABLE character_classes
    ADD COLUMN starting_skills TEXT;
UPDATE character_classes
SET starting_skills = ''
WHERE starting_skills IS NULL;
...
--changeset jeff:53
UPDATE character_classes
SET starting_skills = 'Bandage,Cast Magic,Light Armor,One Handed Weapon'
WHERE name = 'Druid';
UPDATE character_classes
SET starting_skills = 'Backstab,Bandage,Dodge,Light Armor,Medium Armor,One Handed Weapon,Parry,Pickpocket'
WHERE name = 'Rogue';
UPDATE character_classes
SET starting_skills = 'Bandage,Cast Magic,Light Armor,One Handed Weapon,Spell: Magic Armor,Spell: Magic Missile'
WHERE name = 'Wizard';
UPDATE character_classes
SET starting_skills = 'Bandage,Dodge,Dual Wield,Hide,Light Armor,Medium Armor,One Handed Weapon,Parry'
WHERE name = 'Ranger';
UPDATE character_classes
SET starting_skills = 'Bandage,Say Prayer,Light Armor,Medium Armor,One Handed Weapon,Two Handed Weapon,Heavy Armor'
WHERE name = 'Cleric';
UPDATE character_classes
SET starting_skills = 'Bandage,Bash,Dodge,Dual Wield,Light Armor,Medium Armor,One Handed Weapon,Parry,Shield Block,Two Handed Weapon,Heavy Armor'
WHERE name = 'Fighter';
UPDATE character_classes
SET starting_skills = 'Bandage,Bash,Dodge,Dual Wield,Light Armor,Medium Armor,Parry,Say Prayer,Shield Block,Heavy Armor'
WHERE name = 'Paladin';

--changeset jeff:54
INSERT INTO items (id, item_type, wear_location, name, description)
VALUES (1, 'WEAPON', 'PRIMARY', 'Short Sword', 'A basic iron short sword.'),
...
--changeset jeff:55
INSERT INTO items (id, item_type, wear_location, name, description)
VALUES (16, 'RANGED_WEAPON', 'PRIMARY', 'Short Bow', 'A simple wooden short bow.'),
...
--changeset jeff:56
UPDATE character_classes
SET starting_items = '11,7,9,4,16'
WHERE name = 'Druid';
UPDATE character_classes
SET starting_items = '2,5,11,7,9,1'
WHERE name = 'Rogue';
UPDATE character_classes
SET starting_items = '2,11,7,9,17'
WHERE name = 'Wizard';
UPDATE character_classes
SET starting_items = '5,11,7,9,13,1'
WHERE name = 'Ranger';
UPDATE character_classes
SET starting_items = '12,10,8,16,6'
WHERE name = 'Cleric';
UPDATE character_classes
SET starting_items = '12,10,8,6,3,1'
WHERE name = 'Fighter';
UPDATE character_classes
SET starting_items = '12,10,8,15,6,3'
WHERE name = 'Paladin';
...
SELECT setval(pg_get_serial_sequence('server_settings', 'id'), COALESCE(MAX(id), 1), MAX(id) IS NOT NULL)
FROM server_settings;
SELECT setval(pg_get_serial_sequence('character_classes', 'id'), COALESCE(MAX(id), 1), MAX(id) IS NOT NULL)
FROM character_classes;
SELECT setval(pg_get_serial_sequence('rooms', 'id'), COALESCE(MAX(id), 1), MAX(id) IS NOT NULL)
FROM rooms;
...
SELECT setval(pg_get_serial_sequence('effects', 'id'), COALESCE(MAX(id), 1), MAX(id) IS NOT NULL)
FROM effects;
SELECT setval(pg_get_serial_sequence('skills_registry', 'id'), COALESCE(MAX(id), 1), MAX(id) IS NOT NULL)
FROM skills_registry;
SELECT setval(pg_get_serial_sequence('items', 'id'), COALESCE(MAX(id), 1), MAX(id) IS NOT NULL)
FROM items;
...
VALUES (1, 'General World Builder Instructions',
...
SELECT setval(pg_get_serial_sequence('agents', 'id'), COALESCE(MAX(id), 1), MAX(id) IS NOT NULL)
FROM agents;
...
VALUES (2, 'The Great Hall',
        ...
        'INDOORS', 3, 4, 5, 1, NULL, NULL, false, false, false, false, false, false, false, false, false, false, false,
        false),
       (3, 'Library of Ancient Wisdom',
        'Rows of dusty bookshelves line the walls of this quiet chamber, where old maps and forgotten lore rest in careful order.',
        'INDOORS', NULL, 2, NULL, NULL, NULL, NULL, false, false, false, false, false, false, false, false, false,
        false, false, false),
       (4, 'The Alchemist''s Workshop',
        'The air is thick with the smell of strange chemicals and bubbling potions. Benches of glassware crowd the western annex.',
        'INDOORS', NULL, NULL, 2, NULL, NULL, NULL, false, false, false, false, false, false, false, false, false,
        false, false, false),
       (5, 'Portal Gallery',
        'A humming arch of pale light dominates this eastern chamber, its frame etched with old travel sigils and city markers.',
        'INDOORS', NULL, NULL, NULL, 2, NULL, NULL, false, false, false, true, false, false, false, false, false, true,
        false, false),
       (6, 'South Gate Courtyard',
        'Weathered flagstones open into a quiet courtyard beyond the entrance, with a training path leading farther south.',
        'CITY', 1, 12, NULL, NULL, NULL, NULL, true, true, false, false, false, false, true, true, false, false, false,
        false),
       (7, 'East Market Arcade',
        'Canvas awnings shade a row of empty vendor stalls, and the scent of spice still lingers in the air.', 'CITY',
        NULL, NULL, 13, 1, NULL, NULL, false, false, true, true, false, false, false, false, true, true, false, false),
       (8, 'West Watch Barracks',
        'Racks of practice spears and neatly made cots line this guard post overlooking the entrance approach.', 'CITY',
        NULL, NULL, 1, 14, NULL, NULL, false, false, true, true, false, false, false, false, true, true, false, false),
       (9, 'Skybridge Landing',
        'A wind-brushed stone platform hangs above the entrance, with iron rails and stairs climbing toward an observatory.',
        'AIR', NULL, NULL, NULL, NULL, 15, 1, false, false, false, false, true, true, false, false, false, false, true,
        true),
       (10, 'Undercrypt Stairs',
        'Cold stone steps descend beneath the entrance into a torchlit vault where every sound seems swallowed by the earth.',
        'UNDERGROUND_DUNGEON', NULL, NULL, NULL, NULL, 1, NULL, false, false, false, false, true, false, false, false,
        false, false, true, false),
       (11, 'Hall of Maps',
        'Lanterns glow over wall-sized charts of kingdoms, trade roads, and shifting frontiers above the great hall.',
        'INDOORS', NULL, NULL, NULL, NULL, NULL, 2, false, false, false, false, false, true, false, false, false, false,
        false, true),
       (12, 'Lantern Garden',
        'A pocket garden blooms behind the southern courtyard, where paper lanterns sway over clipped hedges and a stone bench.',
        'FIELD', 6, NULL, NULL, NULL, NULL, NULL, true, false, false, false, false, false, true, false, false, false,
        false, false),
       (13, 'Trader''s Ledger Room',
        'Shelves of account books and lockboxes fill this private counting room tucked behind the market arcade.',
        'INDOORS', NULL, NULL, NULL, 7, NULL, NULL, false, false, false, true, false, false, false, false, false, true,
        false, false),
       (14, 'Armory Annex',
        'Polished helms and reserve shields hang in disciplined rows beside a scarred table used for watch briefings.',
        'INDOORS', NULL, NULL, 8, NULL, NULL, NULL, false, false, true, false, false, false, false, false, true, false,
        false, false),
       (15, 'Observatory Apex',
        'A domed chamber of brass lenses and star charts crowns the skybridge, offering a sweeping view over the whole district.',
        'AIR', NULL, 9, NULL, NULL, NULL, NULL, false, true, false, false, false, false, false, true, false, false,
        false, false)
ON CONFLICT (id) DO UPDATE SET name            = EXCLUDED.name,
...
SELECT setval(pg_get_serial_sequence('mobiles', 'id'), COALESCE(MAX(id), 1), MAX(id) IS NOT NULL)
FROM mobiles;
